...
/**
 * 樱花粉主题。
 * <p>樱花红表头搭配粉白斑马纹，柔美温婉，适合电商、美妆、用户运营类报表。</p>
 *
 * @author Martin
 * @version 1.0.0
 * @date 2026/8/7
 */
public class JSakuraPinkTheme extends JAbstractExcelTheme {

    public JSakuraPinkTheme() {
        super("sakuraPink", "樱花粉", "樱花红表头搭配粉白斑马纹，柔美温婉");
    }

    @Override
    protected JRgbColor headerBackground() {
        return JRgbColor.of("D81B60");
    }
