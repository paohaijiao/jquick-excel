...
/**
 * 祖母绿主题。
 * <p>祖母绿表头搭配浅绿斑马纹，宝石质感，适合金融、财富管理类报表。</p>
 *
 * @author Martin
 * @version 1.0.0
 * @date 2026/8/7
 */
public class JEmeraldTheme extends JAbstractExcelTheme {

    public JEmeraldTheme() {
        super("emerald", "祖母绿", "祖母绿表头搭配浅绿斑马纹，宝石质感");
    }

    @Override
    protected JRgbColor headerBackground() {
        return JRgbColor.of("0B5345");
    }
