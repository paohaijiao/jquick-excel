...
/**
 * 冰川主题。
 * <p>冰川蓝表头搭配冰白斑马纹，清冷纯净，适合冷链、冰雪类数据。</p>
 *
 * @author Martin
 * @version 1.0.0
 * @date 2026/8/7
 */
public class JIceTheme extends JAbstractExcelTheme {

    public JIceTheme() {
        super("ice", "冰川", "冰川蓝表头搭配冰白斑马纹，清冷纯净");
    }

    @Override
    protected JRgbColor headerBackground() {
        return JRgbColor.of("5D8AA8");
    }
