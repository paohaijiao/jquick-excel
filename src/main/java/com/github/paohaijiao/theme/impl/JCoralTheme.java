...
/**
 * 珊瑚主题。
 * <p>珊瑚红表头搭配粉白斑马纹，明快活泼，适合促销、活动类数据展示。</p>
 *
 * @author Martin
 * @version 1.0.0
 * @date 2026/8/7
 */
public class JCoralTheme extends JAbstractExcelTheme {

    public JCoralTheme() {
        super("coral", "珊瑚", "珊瑚红表头搭配粉白斑马纹，明快活泼");
    }

    @Override
    protected JRgbColor headerBackground() {
        return JRgbColor.of("E55451");
    }
    ...
    protected JRgbColor footerForeground() {
        return JRgbColor.of("C0392B");
    }

    @Override
    protected JRgbColor titleBackground() {
        return JRgbColor.of("CB4335");
    }
