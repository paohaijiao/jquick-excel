 ...
 * @description
 */
public class JQuickExcelComonExportVisitor extends JQuickExcelExportGraphVisitor {

    public JQuickExcelComonExportVisitor() {
        this.context = new JContext();

    }

    public JQuickExcelComonExportVisitor(JContext context) {
